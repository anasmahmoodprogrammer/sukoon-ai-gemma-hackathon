...
export default function ContentArea({
  ...
  const handleSendMessage = (textToSend: string) => {
    ...
    // Compassionate, empathetic responses with Urdu comfort cues
    setTimeout(() => {
      let reply = "I am listening closely. Your feelings are completely valid, and it takes so much courage to express them. Please take a deep breath with me. You are in a safe, quiet space.";
      const lower = textToSend.toLowerCase();

      if (lower.includes("anxious") || lower.includes("panic") || lower.includes("scared") || lower.includes("darr") || lower.includes("tension")) {
        reply = "Tension and anxiety can feel heavy in the chest. Let's practice simple Box Breathing together right now. Inhale for 4 seconds... Hold... Exhale... Hold. You are safe, and this wave will pass.";
      } else if (lower.includes("sad") || lower.includes("alone") || lower.includes("cry") || lower.includes("ruda") || lower.includes("depressed")) {
        reply = "I'm so sorry you're carrying this sadness. Please know you are not alone, even in the quietest hours. Speak as much or as little as you like—I am here as your comforting friend.";
      } else if (lower.includes("tired") || lower.includes("exhausted") || lower.includes("burnout") || lower.includes("work")) {
        reply = "Your mind and body are calling for peaceful rest. It is okay to set down your responsibilities for a little while. Rest is a form of healing and self-love. You've done enough today.";
      } else if (lower.includes("happy") || lower.includes("excited") || lower.includes("good") || lower.includes("khush") || lower.includes("better")) {
        reply = "Achanak dil khush ho gaya! It brings pure joy to my heart to hear you are feeling lighter. Let's appreciate this brightness. What small thing helped make today a good day?";
      }
      ...
      setIsTyping(false);
      onTriggerToast("Sukoon AI responded", "info");
    }, 1500);
  };
        ...
        <div className="flex flex-col h-[calc(100vh-13.5rem)] min-h-[500px] bg-white rounded-3xl border border-slate-100 shadow-subtle overflow-hidden animate-in fade-in duration-300">
          ...
          <div className="flex-1 overflow-y-auto p-5 space-y-4 scrollbar-thin">
            {messages.map((msg) => (
              ...
              >
                <div className={`p-3.5 rounded-2xl text-xs font-body leading-relaxed shadow-3xs
                  ${msg.sender === "user"
